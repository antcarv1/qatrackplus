...
urlpatterns = [
    ...
    re_path("^composite/$", views.CompositeCalculation.as_view(), name="api.composite"),

    # view for uploads via api
    re_path("^upload/$", views.Upload.as_view(), name="api.upload"),

    # search urls
    re_path("^searcher/test/$", views.test_searcher, name='test_searcher'),
    re_path("^searcher/test_list/$", views.test_list_searcher, name='test_list_searcher'),
    re_path("^searcher/test_list_cycle/$", views.test_list_cycle_searcher, name='test_list_cycle_searcher'),
    re_path("^searcher/test_instance/$", views.test_instance_searcher, name='test_instance_searcher'),
    re_path("^searcher/test_list_instance/$", views.test_list_instance_searcher, name='test_list_instance_searcher'),
